...
if (anyos<15):
    print(" Eres menor que 15 años, no puedes pasar a la sesion de tarde")
if (anyos>17):
    print("Eres mayor que 17 años, no puedes pasar a la sesion de tarde")
if (anyos == 15,17):
...
| 15 , 17  | Tienes la edad permitida, puedes pasar |
